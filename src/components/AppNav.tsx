...
export function AppNav() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-3xl items-center justify-between gap-2 px-3 sm:px-4 h-12">
        <NavLink to="/chat" className="flex items-center gap-1.5 font-display text-sm shrink-0">
          ...
          {userId && (
            <li>
              <button
                ...
                className="flex items-center gap-1.5 rounded-full px-2.5 sm:px-3 py-1.5 text-xs font-medium text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors"
                aria-label="Sign out"
              >
